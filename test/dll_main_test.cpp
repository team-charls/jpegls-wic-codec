...
public:
    ...
    {
        const auto class_factory{com_factory_.get_class_factory(id::jpegls_decoder)};
    ...
    {
        const auto class_factory{com_factory_.get_class_factory(id::jpegls_encoder)};
    ...
    TEST_METHOD(class_factory_unknown_id) // NOLINT
    {
        ...
        const HRESULT result{com_factory_.get_class_factory(id::vendor_team_charls, class_factory)};
